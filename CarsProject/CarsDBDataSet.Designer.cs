...
namespace CarsProject {
    ...
    public partial class CarsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(int Hp, int Price, string Model) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int Hp {
                get {
                    return ((int)(this[this.tableTable.HpColumn]));
                }
                set {
...
namespace CarsProject.CarsDBDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Hp] = @Original_Hp) " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Hp], [Price], [Model]) VALUES (@Hp, @Price, @Model);\r" +
                "\nSELECT Id, Hp, Price, Model FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Hp] = @Hp, [Price] = @Price, [Model] = @Model WHERE (([" +
                "Id] = @Original_Id) AND ([Hp] = @Original_Hp) AND ([Price] = @Original_Price));\r" +
                "\nSELECT Id, Hp, Price, Model FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CarsProject.Properties.Settings.Default.CarsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Hp, Price, Model FROM dbo.[Table]";
        ...
        public virtual int Fill(CarsDBDataSet.TableDataTable dataTable) {
        ...
        public virtual CarsDBDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarsDBDataSet.TableDataTable dataTable = new CarsDBDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarsDBDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_Hp, int Original_Price) {
        ...
        public virtual int Insert(int Hp, int Price, string Model) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Hp));
        ...
        public virtual int Update(int Hp, int Price, string Model, int Original_Id, int Original_Hp, int Original_Price, int Id) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Hp));
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Hp));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Hp, int Price, string Model, int Original_Id, int Original_Hp, int Original_Price) {
            return this.Update(Hp, Price, Model, Original_Id, Original_Hp, Original_Price, Original_Id);
        }
    }
